...
app.controller('FileUploadCtrl', ['$scope', '$http', '$state', '$rootScope', '$localStorage', function ($scope, $http, $state, $rootScope, $localStorage) {
    ...
    $scope.removeSampleFile = function(){
    ...
    $scope.sampleUplaod = function (name){
        
        $scope.sampleFile=name;
        $scope.sampleFileFlag=true;
        console.log($scope.sampleFileFlag);
        ...
        $http.post("/dataset/upload?sampleFileFlag="+$scope.sampleFileFlag+"&sampleFileName="+$scope.sampleFile, fd, {
