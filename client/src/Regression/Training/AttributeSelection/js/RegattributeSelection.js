...
app.controller('AttributeSelectionReg', ['$scope', '$http', '$state', '$rootScope', '$localStorage', function ($scope, $http, $state, $rootScope, $localStorage) {
    ...
    $scope.goBackR = function () {
        ...
        $state.go('regTraining.uploadCSVReg');
    }


    $scope.goNextR = function () {
        ...
        $scope.sendChartDetails();
         $state.go('regTraining.trainReg');
    }

    $http({
        method: "GET",
        url: "/regression/getAttributes?file=" + $localStorage.file + "&userId=" + $localStorage.userId,
  ...
  /* $scope.showGraphScatter = function () {
    ...
    $scope.sendChartDetails = function () {
        ...
        $http({
            method: "POST",
            url: "/regression/sendAttributes?userId=" + $localStorage.userId,
            data: significance,
